        ...
        <aside className='flex items-start gap-6 justify-between w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
          <div>
            ...
            <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
              A UI component that guides users through a multi-step process,
...
export default Stepper;
            ...
            <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
              A stepper that displays only numbers to indicate each step,
...
export default Stepper;
            ...
            <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
              A vertical stepper that displays steps in a top-to-bottom
              ...
              {varticalStepPreview && (
                <div className='p-8 mb-4 flex items-center gap-5 justify-center'>
                  <div className='flex flex-col items-center gap-[10px] justify-center w-full'>
                    ...
                    <div className='flex items-start gap-[20px]'>
                      <div className='flex flex-col items-center'>
                        <p className='w-[35px] h-[35px] flex items-center justify-center bg-gray-200 rounded-full text-gray-500 text-[1rem]'>
                          3
                        </p>
