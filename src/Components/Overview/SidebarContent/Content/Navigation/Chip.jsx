...
const Chip = () => {
  ...
  const handleVariantChipPreview = () => {
    setVariantChipPreview(true);
    setVariantChipCode(false);
  };

  const handleVariantChipCode = () => {
    setVariantChipCode(true);
    setVariantChipPreview(false);
  };
