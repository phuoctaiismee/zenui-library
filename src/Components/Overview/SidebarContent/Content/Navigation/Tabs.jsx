...
"
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is navigation tabs with sliding animation for smooth and
...
export default AnimatedTab;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is navigation tabs with active tab indication using bottom
            borders for clarity.
          </p>
...
export default BottomBorderTab; "
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is navigation tabs with active tab indication using top borders
...
export default DropDown;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is navigation tabs with active tab indication using square
...
export default DropDown;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is navigation tabs with active tab indication using rounded
