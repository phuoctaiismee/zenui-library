      ...
      <aside className='flex items-start gap-6 justify-between w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A rating system with clickable stars or icons, allowing users to
...
export default Rating;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A rating system with hover navigation, allowing users to preview and
...
export default Rating;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A modal window that allows users to submit a rating, often including
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            ...
            {ratingModalPreview && (
              <div className='p-8 mb-4 flex items-center gap-5 justify-center'>
                <div className='bg-white boxShadow rounded-md border border-gray-200 w-full 1024px:w-[80%] p-4 text-center'>
                  <RxCross1 className='float-right py-1.5 text-[1.6rem] text-[#333333] hover:bg-gray-200 rounded-full cursor-pointer' />

                  <h3 className='text-[24px] font-semibold text-[#333333] mt-[40px]'>
...
export default Rating;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A rating system that includes a feedback section, allowing users to
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            ...
            {ratingFeedbackModalPreview && (
              <div className='p-8 mb-4 flex items-center gap-5 justify-center'>
                <div className='bg-white boxShadow rounded-md border border-gray-200 w-full p-4 640px:p-8'>
...
export default Rating;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A rating system where users can select a rating based on a numerical
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            ...
            {rateCountPreview && (
              <div className='p-8 mb-4 flex items-center gap-5 justify-center'>
                <div className='bg-white boxShadow rounded-[30px] border border-gray-200 w-full 640px:w-[80%] p-8'>
                  <div className='p-4 bg-blue-100 w-max rounded-full'>
                    <FaHeart className='text-[1.5rem] text-blue-800' />
                  </div>

                  <h3 className='text-[24px] font-semibold text-[#333333] mt-[20px]'>
                    Hey Drop some Rating!
                  </h3>
                  <p className='text-[14px] font-[400] text-gray-500 mt-[10px]'>
                    hb sdjbchjbhjbsdjh jhb hj hj hj jh hbhujbhb hb hjbhjbh
                    jbhujb hbsdfdsv sdv sdvsd vsvdvvdvsdv
                  </p>
