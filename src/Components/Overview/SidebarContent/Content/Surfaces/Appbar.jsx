        ...
        <div className="w-full 425px:w-[80%]">
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${basicAppPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[106px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default AppbarWithUsericon;
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${appBarWithSearchPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[106px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default AppbarWithSearchbar;  
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${appbarWithIconsPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[106px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default AppbarWithIcons;              
          ...
          <OverviewFooter backUrl='/components/according' backName='accordion' forwardName='image gallery' forwardUrl='/components/image-gallery'/>
        </div>
