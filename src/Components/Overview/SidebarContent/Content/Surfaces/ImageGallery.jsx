      ...
      <aside className='flex items-start justify-between gap-6 w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div className='w-full 425px:w-[80%]'>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is an image gallery with a simple layout for easy browsing and
            viewing.
          </p>
...
export default ImageGallery;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is an image gallery with a complex layout for detailed and
            organized viewing.
          </p>
...
export default ImageGallery;    
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is an image gallery with a sleek layout for stylish and
            organized viewing.
          </p>
...
export default ImageGallery;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is an image gallery with a robust layout for structured and
            efficient viewing.
          </p>
...
export default ImageGallery;  
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is an image gallery with a stylish layout featuring title text
