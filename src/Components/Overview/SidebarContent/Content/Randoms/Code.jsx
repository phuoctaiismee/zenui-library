        ...
        <div>
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${codePreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
<div className="bg-[#d1d1d180] text-[#000000] rounded-md py-1 px-4 tracking-wider font-sans font-[600]">
     npm i @zenui
          ...
          <OverviewFooter backUrl='/components/timeline' backName='timeline' forwardName='snippet' forwardUrl='/components/snippet'/>
        </div>
