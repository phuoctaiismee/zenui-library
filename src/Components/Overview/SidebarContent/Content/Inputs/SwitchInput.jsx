      ...
      <aside className='flex items-start justify-between gap-6 w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is a circle switch button component. Toggle options with a
...
export default InputSwitch;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is a square switch button component. Toggle options with a tap
...
export default InputSwitch;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            Animated switch that provides a smooth transition between on and off
            ...
            {animatedSwitchPreview && (
              <div className='p-8 mb-4 flex flex-wrap items-center gap-5 justify-center'>
                <div
                  ...
                  } border relative p-1 rounded-full w-[70px] cursor-pointer transition-all h-[40px] duration-200`}
                ...
                >
                  <div className='absolute inset-0 flex items-center justify-center'>
                    <div
                      ...
                      } w-[30px] h-[30px] rounded-full bg-white transition-all duration-200`}
                    ></div>
                  </div>
                </div>
                <div
                  className={`${
                    animatedSwitch
                      ? 'bg-primary border-primary'
                      : 'bg-[#f0f0f0] border-gray-200'
                  } border relative p-1 rounded-full w-[65px] cursor-pointer transition-all h-[37px] duration-200`}
                  onClick={handleAnimatedSwitch}
                >
                  <div className='absolute inset-0 flex items-center justify-center'>
                    <div
                      ...
                      } w-[28px] h-[28px] rounded-full bg-white transition-all duration-200`}
                    ></div>
                  </div>
                </div>
                <div
                  className={`${
                    animatedSwitch
                      ? 'bg-primary border-primary'
                      : 'bg-[#f0f0f0] border-gray-200'
                  } border relative p-1 rounded-full w-[60px] cursor-pointer transition-all h-[33px] duration-200`}
                  onClick={handleAnimatedSwitch}
                >
                  <div className='absolute inset-0 flex items-center justify-center'>
                    <div
                      ...
                      } w-[25px] h-[25px] rounded-full bg-white transition-all duration-200`}
                    ></div>
                  </div>
                </div>
                <div
                  className={`${
                    animatedSwitch
                      ? 'bg-primary border-primary'
                      : 'bg-[#f0f0f0] border-gray-200'
                  } border relative p-1 rounded-full w-[55px] cursor-pointer transition-all h-[30px] duration-200`}
                  onClick={handleAnimatedSwitch}
                >
                  <div className='absolute inset-0 flex items-center justify-center'>
                    <div
                      ...
                      } w-[22px] h-[22px] rounded-full bg-white transition-all duration-200`}
                    ></div>
                  </div>
                </div>
              </div>
