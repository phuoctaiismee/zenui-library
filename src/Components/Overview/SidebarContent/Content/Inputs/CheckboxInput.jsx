...
export default CheckboxInput;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            Checkbox with smooth animations for a visually engaging selection
            experience.
          </p>
...
export default CheckboxInput;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A group of checkboxes enabling users to select multiple options from
                ...
                <div className='flex flex-col gap-[10px]'>
                  {[1, 2, 3].map((item) => (
                    ...
                    >
                      ...
                      <span className='text-[1.2rem] text-text'>
                        ZenUI Library
                      </span>
                    </label>
                  ))}
...
export default CheckboxInput;
        ...
        <div className='1024px:flex hidden flex-col gap-4 sticky top-4 right-0 w-[55%]'>
          ...
          {checkboxInputContents.map((item) => (
            <a
              key={item.id}
              href={item.href}
              className={`${
