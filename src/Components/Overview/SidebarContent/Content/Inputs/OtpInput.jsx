      ...
      <aside className='flex items-start justify-between gap-6 w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            Custom OTP input field with navigation controls, allowing users to
            easily move between digits for seamless entry.
          </p>
...
<div className="grid grid-cols-4 gap-[10px] w-full lg:w-[50%]">
    ...
    <input className="p-3 text-center border border-[#bcbcbc] rounded-md outline-none focus:border-primary"
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            OTP input field with keyboard navigation, enabling users to move
            between digits using arrow keys for quick and efficient entry.
          </p>
                ...
                <div className='grid grid-cols-4 gap-[10px] w-full 1024px:w-[50%]'>
                  {Array.from({ length }).map((_, index) => (
                    <input
                      ...
                      max='1'
                      onChange={(e) =>
                        handleAutoNavigationInputChange(e, index)
                      }
