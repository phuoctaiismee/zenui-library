        ...
        <div>
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${messageBadgePreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default MessageBadge;
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${cartBadgePreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default CartBadge;
          ...
          <p className="w-full 425px:w-[80%] text-text text-[1rem]">
            An indicator, typically a small colored dot or icon, showing that a user is currently online and available.
          </p>

          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${onlineBadgePreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default Badge;
          ...
          <p className="w-full 425px:w-[80%] text-text text-[1rem]">
            A badge or icon indicating that a user, account, or content has been verified for authenticity or credibility.
          </p>

          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${verifiedBadgePreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default Badge;
          ...
          <OverviewFooter backUrl='/components/notification' backName='notification' forwardName='tooltip' forwardUrl='/components/tooltip'/>
        </div>
