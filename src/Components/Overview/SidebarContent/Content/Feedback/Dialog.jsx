        ...
        <div>
          ...
          <div className="w-full 425px:w-[80%] border border-border rounded mt-8">
            <div className="relative">
              <div
                  className={`absolute top-0 left-0 w-[90px] h-[40px] z-[1] bg-border transition-all duration-500 ${basicDialogPreview ? 'translate-x-[0px] !w-[100px]' : 'translate-x-[107px] rounded-br'}`}></div>
              <button
                  className={`${
...
export default PopupDialog;
          ...
          <OverviewFooter backUrl='/components/alert-message' backName='alert message' forwardName='testimonial' forwardUrl='/components/testimonials'/>
        </div>
