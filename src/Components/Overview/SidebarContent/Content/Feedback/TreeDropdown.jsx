      ...
      <ul className='space-y-2'>
        {nodes.map((node) => (
          <li key={node.label} className='ml-2'>
            {/* Node Label */}
            <div className='cursor-pointer py-1 px-3 flex items-center rounded-md gap-[5px] hover:bg-blue-50 hover:text-blue-800 group transition-all text-[1rem] duration-200'>
              {node.children && (
                <span className='text-gray-500'>
                  {isOpen1(node) ? (
                    <IoMdArrowDropdown
                      onClick={() => toggleNode1(node)}
            ...
            >
              <ul>{node.children && renderTree1(node.children)}</ul>
            </div>
          </li>
        ))}
      </ul>
        ...
        {nodes.map((node, index) => (
          <li key={node.label} className='ml-2 relative'>
            ...
            >
              {node.children && (
                <span className='text-gray-500 z-10'>
                  {isOpen2(node) ? (
                    <HiOutlineMinusSm
                      onClick={() => toggleNode2(node)}
                      className='group-hover:text-blue-800 text-[1.2rem] bg-white transition-all duration-200 border border-gray-300'
                    />
                  ) : (
                    <GoPlus
                      onClick={() => toggleNode2(node)}
            ...
            <div
              ...
              className={`${
                node.children && isOpen2(node) && index !== nodes.length - 1
                  ? 'max-h-full opacity-100'
                  : 'max-h-0 opacity-0'
              } transition-all duration-500 absolute left-[21px] top-6 w-[1px] bg-gray-200 h-full`}
            ></div>
            ...
            >
              <ul>{node.children && renderTree2(node.children, level + 1)}</ul>
            </div>
          </li>
        ))}
      </ul>
      ...
      <ul className='space-y-2'>
        {nodes.map((node) => (
          <li key={node.label} className='ml-2'>
            ...
            >
              <ul>{node.children && renderTree3(node.children)}</ul>
            </div>
          </li>
        ))}
      </ul>
    ...
    return (
      <ul className='space-y-2'>
        {nodes.map((node) => (
          <li key={node.label} className='ml-2'>
            {/* Node Label */}
            <div className='cursor-pointer py-1 px-3 flex items-center rounded-md gap-[5px] hover:bg-blue-50 hover:text-blue-800 group transition-all text-[0.990rem] duration-200'>
              {node.children && (
                <span className='text-gray-500'>
                  {isOpen4(node) ? (
                    <IoMdArrowDropdown
      ...
      <aside className='flex items-start justify-between gap-6 w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div className='w-full 425px:w-[80%]'>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A data tree is a hierarchical structure of nodes used to organize
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(setDataTreePreview, setDataTreeCode, true)
                }
              >
                Preview
              </button>
              <button
                ...
                onClick={() =>
                  toggleCardView(setDataTreePreview, setDataTreeCode, false)
                }
              >
                Code
              </button>
...
export default TreeDropdown;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A tree with lines shows hierarchical data, with nodes connected by
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              >
                ...
                {/* warning modal */}
                <PremiumTooltip
                  url={'https://buymeacoffee.com/zenuilibrary/e/316753'}
...
export default TreeDropdown;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A directory tree is a hierarchical structure that displays folders
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setDirectoryTreePreview,
                    setDirectoryTreeCode,
                    true
                  )
                }
              >
...
export default TreeDropdown;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A controlled tree checkbox is a tree structure with checkboxes for
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setControlledTreePreview,
                    setControlledTreeCode,
                    true
                  )
                }
              >
              ...
              >
                ...
                {/*  warning modal  */}
                <PremiumTooltip
                  url={'https://buymeacoffee.com/zenuilibrary/e/316746'}
                  setIsPremiumModalOpen={setIsPremiumModalOpen2}
                  isPremiumModalOpen={isPremiumModalOpen2}
                />
              </button>
            </div>
            {controlledTreePreview && (
