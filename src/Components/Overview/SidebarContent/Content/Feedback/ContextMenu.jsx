      ...
      <aside className='flex items-start justify-between gap-6 w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div className='1024px:w-[80%]'>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A context menu is a pop-up that shows relevant actions when you
            right-click an item.
          </p>
                  ...
                  >
                    {menuItems.map((item, index) => (
                      <button
                        ...
                        className={`${
                          item.label === 'Delete' && 'hover:bg-red-50'
                        } w-full px-4 py-2 text-left hover:bg-gray-50 flex items-center gap-3 text-sm text-gray-600`}
                      >
                        <p
                          className={`${
                            item.label === 'Delete' && 'text-red-500'
                          } text-[1.1rem] text-gray-600`}
                        >
                          {item.icon}
                        </p>
                        <p
...
export default ContextMenu;
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            A context menu with a dropdown appears on right-click and includes
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                ...
                onClick={() =>
                  toggleCardView(
                    setDropdownContextMenuPreview,
                    setDropdownContextMenuCode,
                    true
                  )
                }
              >
              ...
              <div className='p-8 mb-4 flex items-center flex-col gap-5 justify-center'>
                ...
                {showMenu2 && (
                  <div
                    ...
                    } fixed bg-white transition-all duration-200 shadow-md rounded-lg py-2 w-48 border border-gray-200`}
                    style={{
                      top: menuPosition2.y,
