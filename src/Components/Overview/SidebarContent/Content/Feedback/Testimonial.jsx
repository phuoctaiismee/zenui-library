      ...
      <aside className='flex items-start justify-between gap-6 w-full 640px:pl-[2.5rem] px-6 640px:px-10'>
        <div className='w-full 425px:w-[80%]'>
          ...
          <p className='w-full 425px:w-[80%] text-text text-[1rem]'>
            This is a testimonial component. Showcase user feedback and reviews
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                className={`${
                  testimonial1Preview && 'text-tabTextColor'
              ...
              <button
                className={`${
                  testimonial1Code && 'text-tabTextColor'
...
export default Testimonial;
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                className={`${
                  testimonial2Preview && 'text-tabTextColor'
                } px-6 py-2 border-b z-[2] relative text-text border-border`}
              ...
              <button
                className={`${
                  testimonial2Code && 'text-tabTextColor'
                } px-6 py-2 border-r z-[2] relative text-text border-b rounded-br border-border`}
            ...
            {testimonial2Preview && (
              <div className='p-8 mb-4 flex items-center flex-col gap-5 justify-center'>
                <div className='w-full p-4 bg-secondary shadow-2xl rounded-lg relative flex flex-col 1024px:flex-row items-start justify-between gap-6'>
...
export default Testimonial;
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                className={`${
                  testimonial3Preview && 'text-tabTextColor'
                } px-6 py-2 border-b z-[2] relative text-text border-border`}
              ...
              <button
                className={`${
                  testimonial3Code && 'text-tabTextColor'
                } px-6 py-2 border-r z-[2] relative text-text border-b rounded-br border-border`}
...
export default Testimonial;
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                className={`${
                  testimonial4Preview && 'text-tabTextColor'
                } px-6 py-2 border-b z-[2] relative text-text border-border`}
              ...
              <button
                className={`${
                  testimonial4Code && 'text-tabTextColor'
                } px-6 py-2 border-r z-[2] relative text-text border-b rounded-br border-border`}
            ...
            {testimonial4Preview && (
              <div className='p-8 mb-4 flex items-center flex-col gap-5 justify-center'>
                <div className='w-full 1024px:w-[70%] bg-secondary shadow-2xl rounded-lg p-6 flex items-center justify-center flex-col'>
                  <img
                    src='https://img.freepik.com/free-photo/young-bearded-man-with-striped-shirt_273609-5677.jpg?size=626&ext=jpg&uid=R134535407&ga=GA1.1.71340048.1688965399&semt=sph'
                    alt='demo/image'
...
export default Testimonial;
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                className={`${
                  testimonial5Preview && 'text-tabTextColor'
                } px-6 py-2 border-b z-[2] relative text-text border-border`}
              ...
              <button
                className={`${
                  testimonial5Code && 'text-tabTextColor'
                } px-6 py-2 border-r z-[2] relative text-text border-b rounded-br border-border`}
...
export default Testimonial;
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                className={`${
                  testimonial6Preview && 'text-tabTextColor'
                } px-6 py-2 border-b z-[2] relative text-text border-border`}
              ...
              <button
                className={`${
                  testimonial6Code && 'text-tabTextColor'
                } px-6 py-2 border-r z-[2] relative text-text border-b rounded-br border-border`}
...
export default Testimonial;
          ...
          <div className='w-full 425px:w-[80%] border border-border rounded mt-8'>
            <div className='relative'>
              ...
              <button
                className={`${
                  testimonial7Preview && 'text-tabTextColor'
                } px-6 py-2 border-b z-[2] relative text-text border-border`}
              ...
              <button
                className={`${
                  testimonial7Code && 'text-tabTextColor'
                } px-6 py-2 border-r z-[2] relative text-text border-b rounded-br border-border`}
